 ...
 *  }
     ...
     *  > };
            ...
            _dataRecv: function (req, raw) {
                ...
                WebIM && WebIM.config.isDebug && console.log("recv: " + req.data);
    ...
    (function (root, factory) {
        ...
        Strophe.Request.prototype = {
            ...
            getResponse: function () {
                ...
                Strophe.debug('recv: ' + Strophe.serialize(node))
                return node;
            },
        ...
        Strophe.Bosh.prototype = {
            ...
            _connect_cb: function (bodyWrap) {
                // console.log('_connect_cb: ', Strophe.serialize(bodyWrap))
            ...
            _doDisconnect: function () {
                //console.log('_doDisconnect', this.rid)
                this.sid = null;
                this.rid = Math.floor(Math.random() * 4294967295);
                if (this._conn._sessionCachingSupported()) {
                    window.sessionStorage.removeItem('strophe-bosh-session');
            ...
            _onRequestStateChange: function (func, req) {
                ...
                if (req.xhr.readyState == 4) {
                    ...
                    if (reqStatus == 200) {
                        ...
                        //console.log('_onRequestStateChange: ', Number(req.rid) + 1)
            ...
            _processRequest: function (i) {
                ...
                if (req.xhr.readyState === 0) {
                    ...
                    var sendFunc = function () {
                        ...
                        // 服务器终止请求后，会重置sid，之后的ping都会失败，所以取消
                        // 没有sid的ping操作终止
